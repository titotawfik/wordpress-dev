...
<section class="billing-section bg-teal--gradient min-vh-100 d-flex align-items-center py-5 fade-on-scroll" id="billing">
    <div class="container">
        <div class="row align-items-center">
            ...
            <?php endif; ?>
            <?php if (!empty($forth_features['video_url'])): ?>
            <!-- Video Section -->
            <div class="col-lg-6 mb-4 fade-in delay-5">
                <div class="video-container pe-lg-4">
                    <div class="ratio ratio-16x9 shadow-lg">
                        <iframe src="<?php echo esc_url($forth_features['video_url']); ?>" title="<?php echo esc_html($forth_features['video_title']); ?>" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
            <?php endif;?>
