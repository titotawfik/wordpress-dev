                ...
                <section class="header-section text-center fade-on-scroll ">
                    <div class="row justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <h2 class="fw-bold mb-3 fade-in delay-4"><?php echo esc_html($first_features['heading']); ?></h2>
                ...
                <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
                    <?php if (!empty($first_features['feature_title_1'])): ?>
                        ...
                        <div class="col fade-in delay-5">
                            <div class="card feature-card p-4 shadow-sm h-100">
                                <div class="card-body">
                                    <h4 class="card-title fw-bold mb-3"><?php echo esc_html($first_features['feature_title_1']); ?></h4>
                    ...
                    <?php if (!empty($first_features['feature_title_2'])): ?>
                        ...
                        <div class="col fade-in delay-5">
                            <div class="card feature-card p-4 shadow-sm h-100">
                                <div class="card-body">
                                    <h4 class="card-title fw-bold mb-3"><?php echo esc_html($first_features['feature_title_2']); ?></h4>
                    ...
                    <?php if (!empty($first_features['feature_title_3'])): ?>
                        ...
                        <div class="col fade-in delay-5">
                            <div class="card feature-card p-4 shadow-sm h-100">
                                <div class="card-body">
                                    <h4 class="card-title fw-bold mb-3"><?php echo esc_html($first_features['feature_title_3']); ?></h4>
                    ...
                    <?php if (!empty($first_features['feature_title_4'])): ?>
                        ...
                        <div class="col fade-in delay-5">
                            <div class="card feature-card p-4 shadow-sm h-100">
                                <div class="card-body">
                                    <h4 class="card-title fw-bold mb-3"><?php echo esc_html($first_features['feature_title_4']); ?></h4>
                    ...
                    <?php if (!empty($first_features['feature_title_5'])): ?>
                        ...
                        <div class="col fade-in delay-5">
                            <div class="card feature-card p-4 shadow-sm h-100">
                                <div class="card-body">
                                    <h4 class="card-title fw-bold mb-3"><?php echo esc_html($first_features['feature_title_5']); ?></h4>
                    ...
                    <?php if (!empty($first_features['feature_title_6'])): ?>
                        ...
                        <div class="col fade-in delay-5">
                            <div class="card feature-card p-4 shadow-sm h-100">
                                <div class="card-body">
                                    <h4 class="card-title fw-bold mb-3"><?php echo esc_html($first_features['feature_title_6']); ?></h4>
            ...
            <?php if (!empty($first_features['image'])): ?>
                ...
                <figure class="text-center mt-5 fade-on-scroll ">
                    ...
                    <div class="row justify-content-center mt-2 fade-in delay-5">
                        <figcaption class="col-lg-6 fs-6"><?php echo esc_html($first_features['image']['description']); ?></figcaption>
                    </div>
                </figure>
            <?php endif; ?>
        </div>
